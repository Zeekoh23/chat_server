...
exports.signup = (0, CatchAsync_1.default)((req, res, next) =>
...
exports.login = (0, CatchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!number || !password) {
      return next(
        new ErrorHandling_1.ErrorHandling(
    ...
    if (!user || !(yield user.correctPassword(password, user.password))) {
      return next(
        new ErrorHandling_1.ErrorHandling("Incorrect number or password", 401)
      ); //unauthorised
    }
...
exports.protect = (0, CatchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    let token;
    if (
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    if (req.cookies.jwt) {
      try {
        ...
        const decoded = yield jsonwebtoken_1.default.verify(
          req.cookies.jwt,
          secret
        );
        console.log(decoded);
...
exports.updatePassword = (0, CatchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    //get user from collection
    const user1 = yield userModel_1.User.findById(req.user.id).select(
      "+password"
    );
    //check if posted current password is correct
    if (
      !(yield user1.correctPassword(req.body.passwordCurrent, user1.password))
    ) {
      return next(
        new ErrorHandling_1.ErrorHandling("Your current password is wrong", 401)
      );
    }
