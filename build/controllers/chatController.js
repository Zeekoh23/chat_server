...
function updatechats(req, res, next, prop) {
    return __awaiter(this, void 0, void 0, function* () {
        const chat = yield chatModel_1.Chat.findOneAndUpdate({ prop: req.params.prop }, req.body, { new: true, runValidators: true });
        if (!chat) {
...
exports.UpdateChat1 = (0, CatchAsync_1.default)((req, res, next, time) => __awaiter(void 0, void 0, void 0, function* () {
    updatechats(req, res, next, time);
}));
exports.UpdateChat2 = (0, CatchAsync_1.default)((req, res, next, lastMessage) => __awaiter(void 0, void 0, void 0, function* () {
...
function updateChatProperty(req, res, next, prop) {
    return __awaiter(this, void 0, void 0, function* () {
        const chat = yield chatModel_1.Chat.updateMany({ email: req.params.email }, { prop: req.body.prop });
        if (!chat) {
...
exports.UpdateChatImage = (0, CatchAsync_1.default)((req, res, next, image) => __awaiter(void 0, void 0, void 0, function* () {
    updateChatProperty(req, res, next, image);
}));
exports.UpdateChatName = (0, CatchAsync_1.default)((req, res, next, name) => __awaiter(void 0, void 0, void 0, function* () {
    updateChatProperty(req, res, next, name);
}));
exports.UpdateChatAbout = (0, CatchAsync_1.default)((req, res, next, about) => __awaiter(void 0, void 0, void 0, function* () {
